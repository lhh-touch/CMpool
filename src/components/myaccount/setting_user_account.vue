...
<div class="setting-user">
    <div class="setting-title">賬戶設置</div>
        <el-form :model="form" :rules="rule" ref="form" label-width="80px">
            <!--<el-form-item label="語 言">
                ...
                <el-option label="繁體中文" value="beijing"></el-option>
            ...
            <el-form-item label="電 郵">
                <el-input placeholder="" v-model="form.email" class="input-with-select" :disabled="true">
                    <el-button slot="append" @click="isEdit = true">點擊修改電郵</el-button>
                </el-input>
            </el-form-item>
            ...
            <div class="edit-email-box">
                ...
                <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                    ...
                    <el-form-item label="新電郵" prop="newEmail">
                        <el-input placeholder="输入新電郵" v-model="ruleForm.newEmail" class="demo-item"> </el-input>
                    </el-form-item>
                    <el-form-item>
      ...
      return {
        ...
        rule: {
          name: [
            ...
            { min: 2, max: 256, message: '2-256位長度文字', trigger: 'blur' }
          ]
        },
        //新旧邮箱名
        ruleForm:{
